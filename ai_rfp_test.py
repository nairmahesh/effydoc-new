...
class TestAIRFPGeneration(unittest.TestCase):
    ...
    def test_rfp_generation_with_valid_data(self):
        ...
        self.assertEqual(response.status_code, 200, "RFP generation failed")
        ...
        for term in key_terms:
            self.assertIn(term.lower(), all_content, f"Generated content missing key term: {term}")
        
        print("✅ AI RFP generation with valid data working correctly")
    
    def test_rfp_generation_without_authentication(self):
    ...
    def test_rfp_generation_with_missing_fields(self):
        ...
        # Assert response status code
        self.assertNotEqual(response.status_code, 200, "Expected validation error")
        print(f"Response status code: {response.status_code}")
        print(f"Response: {response.text}")
        print("✅ Validation check working correctly")
    
    def test_rfp_generation_with_invalid_data_types(self):
